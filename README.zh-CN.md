...
| 类别 | 示例 | 位置 |
|------|------|------|
| **原生** | `run_python_script`、`get_os_info`、`list_native_tools`、`system_health` | `slife/tools/*.py` |
| **MCP / REST** | `run_command`、`read`、`write`、`edit`、`grep`、`search_content`、`fetch` | 通过 slife-mcp 代理 |
