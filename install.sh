...
echo "  pip install 'slife[gguf]' --extra-index-url https://abetlen.github.io/llama-cpp-python/whl/cpu"
echo "  pip install 'slife[transformer]'       # HuggingFace embeddings (~2 GB)"
echo ""
